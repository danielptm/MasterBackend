...
public class TestEmployeeService {
	...
	public void attempttoCreateEmployeeButFailBecauseUsernameAlreadyExists() throws UserDoesNotExistException, UserNameIsNotUniqueException, ServiceException, IllegalUserNameException {
		Employee e1 = this.employeeService.createEmployee("Daniel", randomString+"@me.com", randomString, "secret password", 23.234, 23.23, "image", "2308 n 44 st", "seattle", "usa");
		Employee e2 = this.employeeService.createEmployee("Daniel", randomString+"@me.com", randomString, "secret password", 23.234, 23.23, "image", "2308 n 44 st", "seattle", "usa");
	}

	@Test
	public void getEmployeeItemsFromFacebookLogin(){
