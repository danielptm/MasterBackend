...
public class WelcomeToGlobati{
    ...
    public static String getMail(){
                ...
                "	*/"+
                "		#templateHeader{"+
                "			/*@editable*/background-color:#4f84c7;"+
                ...
                "                        <span style=\"font-size:20px\"><strong>Create</strong></span><br>"+
                "recommendations for those gems of your city that you think a traveler cannot miss. Or use the auto generate feature to quickly add high quality content to your blog."+
                "                    </td>"+
                "                </tr>"+
                "            </tbody></table>"+
                "        </td>"+
                ...
                "                <tbody><tr>"+
                "                    <td valign=\"top\" class=\"mcnTextContent\">"+
                "                        <span style=\"font-size:22px\"><strong>Inform</strong></span><br>"+
                "travelers about cool events going on in your city. Don't know what's going on? Then check out the event feed in your profile, and with a couple clicks, you can find out what's going on and post the events to your blog."+
                "                    </td>"+
                "                </tr>"+
                "            </tbody></table>"+
                "        </td>"+
                ...
                "                                <a class=\"mcnButton \" title=\"Sign up now\" href=\"http://admin.globati.com\" target=\"_self\" style=\"font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;\">Sign up now</a>"+
                "                            </td>"+
                "                        </tr>"+
                "                    </tbody>"+
                "                </table>"+
